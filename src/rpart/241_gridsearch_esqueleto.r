...
ksemillas  <- c(298043, 133387, 987353, 135463, 287347) #reemplazar por las propias semillas
...
for( vcp  in  c( 0, 0.005, 0.05, 0.1, 0.5, 0.75 )  )
{
for( vminbucket  in  c( 2, 3, 5, 10, 20, 30 )  )  
{
