...
Estrategia_B  <- function()
{
  ...
  planilla_cazatalentos[ ids_juegan2,  error := (aciertos1 - aciertos2)^2 ]  #registro en la planilla
  planilla_cazatalentos[ ids_juegan2,  suma := aciertos1 + aciertos2 ]
  planilla_cazatalentos[ ids_juegan2,  delta := suma - error ]
  
  
  #Ronda 3 -------------------------------------------------------
  #A la mitad mejor la hago tirar 70 tiros cada uno
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  q1  <- planilla_cazatalentos[ ids_juegan2, quantile(delta, 0.25) ]
  q4  <- planilla_cazatalentos[ ids_juegan2, quantile(delta, 0.75) ]
  ids_juegan3  <- planilla_cazatalentos[ ids_juegan2 ][ delta >= q1, id ]
  ids_juegan3  <- planilla_cazatalentos[ ids_juegan3 ][ delta <= q4, id ]
  ...
  planilla_cazatalentos[ ids_juegan3,  error := error + (aciertos2 - aciertos3)^2 ]  #registro en la planilla
  planilla_cazatalentos[ ids_juegan3,  suma := aciertos3 + suma ]
  planilla_cazatalentos[ ids_juegan3,  delta := suma - error ]
  
  
  #Ronda 4 -------------------------------------------------------
  #A la mitad mejor la hago tirar 70 tiros cada uno
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  q1  <- planilla_cazatalentos[ ids_juegan3, quantile(delta, 0.25) ]
  q4  <- planilla_cazatalentos[ ids_juegan3, quantile(delta, 0.75) ]
  ids_juegan4  <- planilla_cazatalentos[ ids_juegan3 ][ delta >= q1, id ]
  ids_juegan4  <- planilla_cazatalentos[ ids_juegan4 ][ delta <= q4, id ]
  ...
  planilla_cazatalentos[ ids_juegan4,  error := error + (aciertos3 - aciertos4)^2 ]  #registro en la planilla
  planilla_cazatalentos[ ids_juegan4,  suma := suma + aciertos4 ]
  planilla_cazatalentos[ ids_juegan4,  delta := suma - error ]
  
  
  #Ronda 5 -------------------------------------------------------
  #A la mitad mejor la hago tirar 70 tiros cada uno
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  q1  <- planilla_cazatalentos[ ids_juegan4, quantile(delta, 0.25) ]
  q4  <- planilla_cazatalentos[ ids_juegan4, quantile(delta, 0.75) ]
  ids_juegan5  <- planilla_cazatalentos[ ids_juegan4 ][ delta >= q1, id ]
  ids_juegan5  <- planilla_cazatalentos[ ids_juegan5 ][ delta <= q4, id ]
  ...
  planilla_cazatalentos[ ids_juegan5,  error := error + (aciertos5 - aciertos4)^2 ]  #registro en la planilla
  planilla_cazatalentos[ ids_juegan5,  suma := suma + aciertos5 ]
  planilla_cazatalentos[ ids_juegan5,  delta := suma - error ]
  
  
  #Ronda 6 -------------------------------------------------------
  #A la mitad mejor la hago tirar 200 tiros cada uno
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  q1  <- planilla_cazatalentos[ ids_juegan5, quantile(delta, 0.25) ]
  q4  <- planilla_cazatalentos[ ids_juegan5, quantile(delta, 0.75) ]
  ids_juegan6 <- planilla_cazatalentos[ ids_juegan5 ][ delta >= q1, id ]
  ids_juegan6  <- planilla_cazatalentos[ ids_juegan6 ][ delta <= q4, id ]
  ...
  planilla_cazatalentos[ ids_juegan6,  error := error + (aciertos5 - aciertos6)^2 ]  #registro en la planilla
  planilla_cazatalentos[ ids_juegan6,  suma := suma + aciertos6 ]  
  planilla_cazatalentos[ ids_juegan6,  delta := suma - error ]
  
  
  #Epilogo
  #El cazatalentos toma una decision, elige al que mas aciertos tuvo en la ronda2
  pos_mejor <-  planilla_cazatalentos[ , which.max(delta) ]
