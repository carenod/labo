...
PARAM <- list()
PARAM$base <- "./exp/005_SM_semillero/"
...
for (archivo in archivos) {
  ...
  ksemilla <- strtoi(sapply(strsplit(archivo, "_"), "[", 6))
...
# ls | grep "^semillero" | while read -r line ; do kaggle competitions submit -c dm-eyf-2022-ultima -f $line -m "Message"; done

# kaggle competitions submit -c dm-eyf-2022-ultima -f semillero_base_10000.csv -m "base 100 seeds"