...
PARAM <- list()
PARAM$base <- "./exp/005_SM_semillero_ambos/"
...
for (archivo in archivos) {
  ...
  tb_ranking_semillerio[tb_prediccion, 
                        paste0("rank_", ksemilla, archivo) := rank,
...
setwd(paste0(PARAM$base, "/envios_200seeds"))
...
# kaggle competitions submit -c dm-eyf-2022-ultima -f semillero_base_11000.csv -m "ambos 100 seeds"