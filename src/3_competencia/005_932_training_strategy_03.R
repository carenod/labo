...
PARAM  <- list()
PARAM$experimento <- "005_932_training_strategy_03"

PARAM$exp_input  <- "004_925_FE_historica"

PARAM$future       <- c( 202107 )

PARAM$final_train  <- c( 202105, 202104, 202103, 202102, 202101,
