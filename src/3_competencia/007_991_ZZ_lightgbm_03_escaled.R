...
PARAM  <- list()
PARAM$experimento  <- "007_991_ZZ_lightgbm_03_escaled"
PARAM$exp_input  <- "006_941_HT_lightgbm_03"
...
arch_log  <- paste0( base_dir, "exp/", PARAM$exp_input, "/BO_log03-escaled.txt" )
