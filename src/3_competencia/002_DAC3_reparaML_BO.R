...
PARAM$experimento  <- "003_DAC_reparar" # DAC porque es mio, 2 por la segunda competencia

PARAM$input$dataset       <- "./exp/03_DAC_reparar/dataset_ML.csv.gz"
...
# mejores hp:
# learning_rate 0.0120129081184527
# num_iterarions 3184
# feature_fraction 0.624162402976741
# min_data_in_leaf 2
# num_leaves 337

PARAM <- list()
PARAM$experimento  <- "003_DAC_reparar_ML_predicion"
...
PARAM$finalmodel$learning_rate     <-     0.0120129081184527
PARAM$finalmodel$num_iterations    <-    3184
PARAM$finalmodel$num_leaves        <-   337
PARAM$finalmodel$min_data_in_leaf  <-   2
PARAM$finalmodel$feature_fraction  <-      0.624162402976741
