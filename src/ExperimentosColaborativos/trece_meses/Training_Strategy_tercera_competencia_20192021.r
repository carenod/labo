...
PARAM  <- list()
PARAM$experimento <- "EC_TS9320_TRAINING20192021_trece_meses"

PARAM$exp_input  <- "EC_FE9250_replica_original"

PARAM$future       <- c( 202107 )

#[201901, 202105]

PARAM$final_train  <- c(202002,202003,202004,202005,202007,202008,202009,202010, 202011, 202012, 202101, 202102, 202103)

PARAM$train$training     <- c( 202002,202003,202004,202005,202007,202008,202009,202010, 202011, 202012, 202101, 202102, 202103)
