...
PARAM <- list()
PARAM$experimento <- "EC_ZZ9410_semillerio_replica_original"
PARAM$exp_input <- "EC_TS9320_TRAINING20192021_replica_original"
...
arch_log  <- paste0( base_dir, "exp/", PARAM$exp_input, "/BO_log_AD.txt" )
