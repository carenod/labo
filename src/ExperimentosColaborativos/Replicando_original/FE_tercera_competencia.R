...
PARAM  <- list()
PARAM$experimento  <- "EC_CA9060_recplica_original"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento  <- "EC_DR9141_replica_original"

PARAM$exp_input  <- "EC_CA9060_replica_original"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "EC_FE9250_replica_original"

PARAM$exp_input  <- "EC_DR9141_replica_original"
