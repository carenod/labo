...
PARAM$experimento  <- "001_DAC2_cloud" # DAC porque es mio, 2 por la segunda competencia
...
setwd("D:/FCEN/Materias/DataMining/Materias/DMEF/")
PARAM <- list()
PARAM$experimento  <- "005_DAC2_menos_importantes"
...
##### Divido variables nuevas multiplicando las mas importantes #####
# La rta seleccionada en kaggle no tiene esta seccion
...
vars_for_pca <- paste0(campos_frank, "_r")
vars_for_pca = vars_for_pca[! vars_for_pca %in% c("foto_mes", "numero_de_cliente", "clase01",
                                                  "ccajas_otras_r", "Visa_mpagado_r", "Visa_Finiciomora_r")]
